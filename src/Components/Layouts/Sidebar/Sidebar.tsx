          ...
          <div className="main-sidebar-header active">
            ...
            <Link className='desktop-logo logo-dark active' to={`${import.meta.env.BASE_URL}indexpage`}>
              <img
                ...
                alt="logo"
              /></Link>
            <Link className='logo-icon mobile-logo icon-light active' to={`${import.meta.env.BASE_URL}indexpage`}>
              <img
                src={favicon}
                className=""
                alt="logo"
              /></Link>
            <Link className='logo-icon mobile-logo icon-dark active' to={`${import.meta.env.BASE_URL}indexpage`}>
              <img
                src={faviconWhite}
                className=""
                alt="logo"
