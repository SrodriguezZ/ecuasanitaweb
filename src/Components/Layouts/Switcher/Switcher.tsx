                ...
                <div className="predefined_styles">
                  <div className="swichermainleft text-center">
                    <div className="p-3 d-grid gap-2">
                      <a href='https://react.spruko.com/valex/' className="btn ripple btn-primary mt-0">View Demo</a>
                      <Link to='https://themeforest.net/item/valex-react-typescript-admin-dashboard-template/43406387' className="btn ripple btn-info">Buy Now</Link>
                    ...
                    <div className="skin-body">
                      <div className="switch_section">
                        <div className="switch-toggle d-flex">
                          ...
                          <div className="">
                            <input className="input-color-picker color-primary-light" defaultValue="#0162e8" id="colorID" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border" data-id7="transparentcolor" name="lightPrimary" onChange={(ele) => { changePrimaryColor(ele.target.value) }} />
                          </div>
                        </div>
                        <div className="switch-toggle d-flex mt-2">
