...
export function name() {
  ...
  // let primaryColorVal:any = getComputedStyle(document.documentElement).getPropertyValue("--primary-bg-color").trim();

  let primaryColorVal: any

  if (typeof window) {
    getComputedStyle(document.documentElement).getPropertyValue("--primary-bg-color").trim()
  }
